    ...
    null == window.bookWidgetLoading && (window.bookWidgetLoading = {}), String.prototype.safeVarName = function(a) {
        ...
        var i, j = !1,
            ...
            d = {
                ...
                searchShow: "open",
                buttonImageOnly: !1,
                beforeShow: function(d, c) {
                    var a = $("#ui-datepicker-div"),
                        b = $("#" + c.id).closest("[data-dp-class]");
                    a.removeClass(a.attr("data-dp-class")), a.addClass(b.attr("data-dp-class")), a.attr("data-dp-class", b.attr("data-dp-class")), a.addClass("book-widget book-datepicker")
                },
                loadJQueryUI: !0,
                fontSize: "15px",
                color: "#222222",
                ...
                widgetTitle: "Choose your dates",
                defaultNightsAdvance: 14,
                defaultNumNight: 1,
                maxAdult: 10,
                maxChild: 10,
                numMonth: 1,
                ...
                weekFirstDay: 1,
                pastColor: "#cccccc",
                pastBackgroundColor: "#f5f5f5",
                requestColor: "#339900",
                requestBackgroundColor: "#5bc0de",
                unavailableColor: "#f5f5f4",
                unavailableBackgroundColor: "#cccccc",
                availableColor: "#ffffff",
                availableBackgroundColor: "#58c91f",
                availableDays: !1,
                peopleSelection: 1,
                defaultNumAdult: 2,
                defaultNumChild: 0,
        ...
        function t(a, g) {
            ...
            switch (k.widgetType) {
                ...
                case "AvailabilityCalendar":
                    c = '<div class="book-widget book-widget-holder"> <div class="book-container"> <div class="book-row"> <div class="book-col-12"> <div class="book-widget-bg book-widget-calendar-size book-widget-size-all book-widget-calendar book-block"><div class="book-form-title b24-widget-title" data-translate="1">Click your arrival date</div> <div  class="book-check-in-4 book-dates book-centered dpInline book-widget book-datepicker"> <form class="hide"><input type="hidden" name="checkin"/></form> </div></div></div></div></div></div>'
            }
            a.html(c), a.attr("data-feed-var-name", a.attr("id").safeVarName()), $(document.body).addClass("book-body"), "AvailabilityCalendar" !== k.widgetType && (2 === k.peopleSelection ? $("#book-guests-holder", a).remove() : ($("#book-adults-holder", a).remove(), $("#book-children-holder", a).remove(), 0 === k.peopleSelection && $("#book-guests-holder", a).remove()), 2 === k.dateSelection || 0 === k.dateSelection ? ($("#book-checkout-holder", a).remove(), $("#book-nights-holder", a).removeClass("book-col-12"), $("#book-nights-holder", a).addClass("book-col-6"), 0 === k.dateSelection && $("#book-nights-holder", a).remove()) : 1 === k.dateSelection && $("#book-nights-holder", a).remove(), "BookingBoxMini" === k.widgetType && 3 === k.dateSelection && (1 === k.peopleSelection ? $("#book-guests-holder", a).before($("#book-nights-holder", a)) : $("#book-nights-holder", a).addClass("m-top")), ("BookingBox" === k.widgetType || "BookingStrip" === k.widgetType && 2 === k.dateSelection) && $("#book-nights-holder", a).removeClass("book-col-6"), "BookingBoxMini" === k.widgetType && $(".book-widget-mini .book-form-group").each(function(b, c) {
                var a = $(this).children("div");
                1 === a.length && (a.removeClass("book-col-6"), a.addClass("book-col-12"))
            }), $.each(a.find("select"), function(b, g) {
                var a = $(g),
                    b = a.data("default-value"),
                    c = a.data("max-value");
                "numadult" === a.attr("name") ? (b = k.defaultNumAdult, c = k.maxAdult) : "numchild" === a.attr("name") && (b = k.defaultNumChild, c = k.maxChild), b > c && (b = c), b -= a.data("min-value");
                for (var d = a.data("min-value"); d <= c; d++) {
                    var e = 1 === d ? a.data("translate-min") : a.data("translate-other"),
                        f = d;
                    void 0 !== BEDS24_LANGS[e] && void 0 !== BEDS24_LANGS[e][k.widgetLang] && (f += " " + BEDS24_LANGS[e][k.widgetLang]), a.append('<option value="' + d + '">' + f + "</option>")
                }
                $("option:eq(" + b + ")", a).prop("selected", !0)
            }));
            var b = a.find("form");
            if (b.attr("target", k.formTarget), b.attr("action", k.formAction), void 0 !== k.ownerid && b.append('<input type="hidden" name="ownerid" value="' + k.ownerid + '"/>'), void 0 !== k.propid && (b.append('<input type="hidden" name="propid" value="' + k.propid + '"/>'), a.attr("data-propid", k.propid)), void 0 !== k.roomid && (b.append('<input type="hidden" name="roomid" value="' + k.roomid + '"/>'), a.attr("data-roomid", k.roomid)), void 0 !== k.referer && b.append('<input type="hidden" name="referer" value="' + k.referer + '"/>'), void 0 !== k.redirect && "" !== k.redirect && b.append('<input type="hidden" name="redirect" value="' + k.redirect + '"/>'), void 0 !== k.widgetLang && b.append('<input type="hidden" name="lang" value="' + k.widgetLang + '"/>'), void 0 !== k.group && b.append('<input type="hidden" name="group" value="' + k.group + '"/>'), void 0 !== k.noGroup && b.append('<input type="hidden" name="nogroup" value="' + k.noGroup + '"/>'), void 0 !== k.customParameter) {
                parameters = k.customParameter.split("&");
                for (var h = 0; h < parameters.length; h++) {
                    var n = parameters[h].match(/^(.*?)=/)[1],
                        o = parameters[h].match(/\=(.*)/)[1];
                    b.append('<input type="hidden" name="' + n + '" value="' + o + '"/>')
                }
            }
            var d = !1,
                e = $(".book-panel-advancedsearch", b);
            void 0 !== k.search1 && (d = !0, k.search1.name = "category1", u(e, k.search1)), void 0 !== k.search2 && (d = !0, k.search2.name = "category2", u(e, k.search2)), void 0 !== k.search3 && (d = !0, k.search3.name = "category3", u(e, k.search3)), void 0 !== k.search4 && (d = !0, k.search4.name = "category4", u(e, k.search4));
            var p = $('<div class="book-clearfix"></div>');
            if (e.append(p), !1 === d) $(".book-advancedsearch", b).remove();
            else {
                var q, f = k.searchLinkText,
                    i = $("#collapseAdvancedSearch", b);
                i.addClass("book" + k.widgetType + "AdvancedSearch"), void 0 !== BEDS24_LANGS[f] && void 0 !== BEDS24_LANGS[f][k.widgetLang] && (f = BEDS24_LANGS[f][k.widgetLang]), $("#advanced-search-link", b).html(f + '<span class="caret"></span>'), "hidden" === k.searchShow ? $("#advanced-search-link", b).on("click", function() {
                    i.is(":hidden") ? i.slideDown("slow") : i.slideUp("slow")
                }) : "open" === k.searchShow && ($(".book-agencysearchlink", b).remove(), i.removeClass("book-hide")), q = -1, $(".book-form-control").each(function() {
                    q = q > $(".book-form-control").height() ? q : $(".book-form-control").height()
                }), $(".book-form-control").each(function() {
                    $(".book-form-control").height(q + 3)
                })
            }
            void 0 !== g.widgetTitle && $(".b24-widget-title", a).length > 0 && $(".b24-widget-title", a).html(g.widgetTitle), void 0 !== g.buttonTitle && $('button[type="submit"]', a).html(g.buttonTitle)
        }

        function u(a, b) {
            "BookingBoxMini" === k.widgetType ? function(d, b) {
                if ("select" === b.type) {
                    var e = $('<div class="book-col-6"></div>'),
                        f = $('<div class="book-col-12 advanced-select-booking-box-mini"></div>'),
                        g = $('<select name="' + b.name + '" class="book-form-control"></select>');
                    for (var c in g.append('<span class="caret-select-box"></span>'), b.options) g.append('<option value="' + c + '">' + b.options[c] + "</option>");
                    void 0 !== b.label && e.append($('<label class="">' + b.label + "</label>")), f.append(g), f.append('<span class="caret-select-box"></span>'), e.append(f), d.append(e)
                } else if ("checkHorizontal" === b.type) {
                    var a = "";
                    for (var c in b.options) a += '<li><label><input type="checkbox" name="' + c + '" value="1"/>&nbsp' + b.options[c] + "</label></li>";
                    a = '<ul class="book-checkboxhorizontal">' + a + "</ul>", void 0 !== b.label && (a = '<label class="book-col-12">' + b.label + a + "</label>"), a = '<div class="book-agency-search-checkbox book-lower bookinline-block book-col-12 ">' + a + "</div>", d.append($(a))
                } else if ("checkVertical" === b.type) {
                    var a = "";
                    for (var c in b.options) a += '<li><label><input type="checkbox" name="' + c + '" value="1"/>&nbsp' + b.options[c] + "</label></li>";
                    a = '<ul class="book-checkboxvertical">' + a + "</div>", void 0 !== b.label && (a = '<label class="book-col-12 book-control-label">' + b.label + a + "</label>"), a = '<div class="book-agency-search-checkbox book-lower bookinline-block book-col-12 ">' + a + "</div>", d.append($(a))
                }
            }(a, b) : "BookingBox" === k.widgetType ? function(d, a) {
                if ("select" === a.type) {
                    var e = $('<div class="book-selectholder book-form-group"></div>'),
                        f = $('<div class="book-col-7"></div>'),
                        g = $('<div class="book-col-12 advanced-select-booking-box-mini"></div>'),
                        h = $('<select name="' + a.name + '" class="book-form-control"></select>');
                    for (var c in h.append('<span class="caret"></span>'), a.options) h.append('<option value="' + c + '">' + a.options[c] + "</option>");
                    void 0 !== a.label ? e.append($('<label class="book-col-5 book-control-label">' + a.label + "</label>")) : f.removeClass("book-col-7").addClass("book-col-12"), g.append(h), g.append('<span class="caret-select-box"></span>'), f.append(g), e.append(f), d.append(e)
                } else if ("checkHorizontal" === a.type) {
                    var b = "";
                    for (var c in a.options) b += '<li><label><input type="checkbox" name="' + c + '" value="1"/>&nbsp' + a.options[c] + "</label></li>";
                    b = '<ul class="book-checkboxhorizontal book-col-7">' + b + "</ul>", void 0 !== a.label && (b = '<label class="book-col-5 book-control-label">' + a.label + "</label>" + b);
                    var i = $(b = '<div class="book-agency-search-checkbox book-lower bookinline-block book-form-group">' + b + "</div>");
                    (void 0 === a.label || "" === a.label) && $(".book-checkboxhorizontal", i).removeClass("book-col-7").addClass("book-col-12"), d.append(i)
                } else if ("checkVertical" === a.type) {
                    var b = "";
                    for (var c in a.options) b += '<li><label><input type="checkbox" name="' + c + '" value="1"/>&nbsp' + a.options[c] + "</label></li>";
                    b = '<ul class="book-checkboxvertical book-col-7">' + b + "</div>", void 0 !== a.label && (b = '<label class="book-col-5 book-control-label">' + a.label + "</label>" + b), b = '<div class="book-agency-search-checkbox book-lower bookinline-block  book-form-group">' + b + "</div>", d.append($(b))
                }
            }(a, b) : "BookingStrip" === k.widgetType && function(d, b) {
                if ("select" === b.type) {
                    var e = $('<div class="book-selectholder book-form-group"></div>'),
                        f = $('<div class="book-col-12"></div>'),
                        g = $('<select name="' + b.name + '" class="book-form-control"></select>');
                    for (var c in b.options) g.append('<option value="' + c + '">' + b.options[c] + "</option>");
                    void 0 !== b.label && e.append($('<label class="book-col-12 book-control-label">' + b.label + "</label>")), f.append(g), f.append('<span class="caret-select-box"></span>'), e.append(f), d.append(e)
                } else if ("checkHorizontal" === b.type) {
                    var a = "";
                    for (var c in b.options) a += '<li><label><input type="checkbox" name="' + c + '" value="1"/>&nbsp' + b.options[c] + "</label></li>";
                    a = '<ul class="book-checkboxhorizontal  book-col-12 book-form-control">' + a + "</ul>", void 0 !== b.label && (a = '<label class="book-col-5 book-control-label">' + b.label + "</label>" + a), a = '<div class="book-agency-search-checkbox book-lower bookinline-block book-form-group">' + a + "</div>", d.append($(a))
                } else if ("checkVertical" === b.type) {
                    var a = "";
                    for (var c in b.options) a += '<li><label><input type="checkbox" name="' + c + '" value="1"/>&nbsp' + b.options[c] + "</label></li>";
                    a = '<ul class="book-checkboxvertical book-col-12">' + a + "</div>", void 0 !== b.label && (a = '<label class="book-col-5 book-control-label">' + b.label + "</label>" + a), a = '<div class="book-agency-search-checkbox book-lower bookinline-block  book-form-group">' + a + "</div>", d.append($(a))
                }
            }(a, b)
        }
        ...
        function v(b, c) {
            var a = new Date(b);
            return a.setDate(a.getDate() + c), a
        }
        ...
        function w(a, b) {
            $(a).change(function() {
                var d = $(a),
                    e = $(b),
                    c = d.datepicker("getDate", "+1d"),
                    f = d.datepicker("getDate", "+1d"),
                    g = d.datepicker("getDate", "+1d");
                f.setDate(c.getDate() + k.minNumNight), g.setDate(c.getDate() + k.maxNumNight), c.setDate(c.getDate() + i), e.datepicker("option", "minDate", f), e.datepicker("option", "maxDate", g), e.datepicker("setDate", c), n && setTimeout(function() {
                    e.hasClass("dpInline") || (e.datepicker("show"), activeDatepicker = e.attr("id"))
                }, 10)
            })
        }

        function x(a, b) {
            if (void 0 === window[a.attr("data-feed-var-name")]) {
                var c = !1;
                "object" == typeof l.availableDays && (c = JSON.stringify(l.availableDays)), a.append('<script type="text/javascript"> var ' + a.attr("data-feed-var-name") + " = " + c + "; </script>")
            }
            "object" == typeof b ? ($("#ui-datepicker-div").finish(), b.datepicker("option", "beforeShowDay", "object" == typeof l.availableDays ? y : A), $("#ui-datepicker-div").stop()) : I(a), K(), L(), j = !0
        }

        function y(c) {
            var a = B(c),
                f = B(new Date),
                b = window[p.attr("data-feed-var-name")];
            if (a < f) return [!1, "ui-state-past"];
            if (-1 !== this.id.search("checkout")) {
                var g = C(this),
                    d = z(c, g, b);
                if (d) return d
            }
            if (void 0 === b[a]) return [!0, "ui-state-available"];
            if (0 === b[a]) {
                var e = !1;
                return void 0 !== $(this).data("unavailable-click") && (e = $(this).data("unavailable-click")), [e, "ui-state-reserved"]
            }
            return 1 === b[a] ? [!0, "ui-state-available"] : 2 === b[a] ? [!0, "ui-state-request"] : void 0
        }
        ...
        function z(a, b, c) {
            ...
            var e = B(d);
            return E(a, b) || F(a, b) || D(c, b, d, 0) ? [!1, "ui-state-unavailable"] : 1 === c[e] ? D(c, b, d, 2) ? [!0, "ui-state-request"] : [!0, "ui-state-available"] : 2 === c[e] ? [!0, "ui-state-request"] : void 0
        }

        function A(a) {
            var b = B(a),
                c = B(new Date);
            return b < c ? [!1, "ui-state-past"] : [!0, "ui-state-available"]
        }
        ...
        function B(a) {
            ...
            return d + "-" + (b[1] ? b : "0" + b[0]) + "-" + (c[1] ? c : "0" + c[0])
        }

        function C(a) {
            var b = $(a).closest(".book-widget-holder").find(".hasDatepicker");
            return $(b).datepicker("getDate")
        }
        ...
        function E(b, c) {
            var a = new Date(c);
            return a.setDate(a.getDate() + k.minNumNight), b.getTime() < a.getTime()
        }

        function F(b, c) {
            var a = new Date(c);
            return a.setDate(a.getDate() + k.maxNumNight), b.getTime() > a.getTime()
        }

        function G(b, d) {
            var c = b.attr("data-feed-var-name"),
                e = a + "scripts/availability.php";
            if (void 0 !== b.attr("data-propid")) c += "_propid_" + b.attr("data-propid"), e += "?propid=" + b.attr("data-propid");
            else {
                if (void 0 === b.attr("data-roomid")) return x(b, d), !0;
                e += "?roomid=" + b.attr("data-roomid"), c += "_roomid_" + b.attr("data-roomid")
            }
            if ("undefined" != typeof Storage) {
                if (sessionStorage[c]) return l.availableDays = JSON.parse(sessionStorage.getItem(c)), x(b, d), !0;
                if (!0 !== window.bookWidgetLoading[c]) window.bookWidgetLoading[c] = !0;
                else if (H(c, b, d)) return !0
            }
            $.ajax({
                url: e,
                type: "GET",
                ...
                dataType: "json",
                success: function(a) {
                    "undefined" != typeof Storage && (window.bookWidgetLoading[c], sessionStorage.setItem(c, JSON.stringify(a))), l.availableDays = a, x(b, d)
                },
                error: function(a) {
                    console.log(a), x(b, d)
                }
        ...
        async function H(a, c, d) {
            for (let b = 0; b < 100; b++) {
                if (sessionStorage[a]) return l.availableDays = JSON.parse(sessionStorage.getItem(a)), x(c, d), !0;
        ...
        function I(c) {
            ...
            switch (k.widgetType) {
                case "BookingBox":
                    var f = "booking-box-checkin-" + xmlcalGlobalidIndex++,
                        g = "booking-box-checkout-" + xmlcalGlobalidIndex++,
                        a = $('[data-check-in="1"]', c),
                        b = $('[data-check-out="1"]', c);
                    a.attr("id", f), b.attr("id", g);
                    var e = "alt-checkin-" + m++,
                        h = "alt-checkout-" + m++;
                    $('input[name="checkin"]', c).attr("id", e), $('input[name="checkout"]', c).attr("id", h), a.data("unavailable-click", !1), b.data("unavailable-click", !0), d.minDate = j, d.onSelect = w("#" + f, "#" + g), a.datepicker(d), b.datepicker(n), a.datepicker("option", "altField", "#" + e), b.datepicker("option", "altField", "#" + h), a.datepicker("setDate", v(j, l.defaultNightsAdvance)), a.change(), a.parent().append("<i class='icon-book-calendar '></i>"), b.parent().append("<i class='icon-book-calendar '></i>"), $(".book-widget .icon-book-calendar").click(function() {
                        $(this).prev().focus()
                    });
                    break;
                case "BookingBoxMini":
                    var f = "booking-box-mini-checkin-" + xmlcalGlobalidIndex++,
                        g = "booking-box-mini-checkout-" + xmlcalGlobalidIndex++,
                        a = $('[data-check-in="1"]', c),
                        b = $('[data-check-out="1"]', c);
                    a.attr("id", f), b.attr("id", g);
                    var e = "alt-checkin-" + m++,
                    ...
                    break;
                case "BookingStrip":
                    var f = "booking-strip-checkin-" + xmlcalGlobalidIndex++,
                        g = "booking-strip-checkout-" + xmlcalGlobalidIndex++,
                        a = $('[data-check-in="1"]', c),
                        b = $('[data-check-out="1"]', c);
                    a.attr("id", f), b.attr("id", g);
                    var e = "alt-checkin-" + m++,
                    ...
                    break;
                case "AvailabilityCalendar":
                    var a = $(".book-check-in-4", c),
                        e = "alt-checkin-" + m++;
                    $('input[name="checkin"]', c).attr("id", e), d.minDate = j, d.numberOfMonths = l.numMonth, d.inline = !0, d.altField = "#" + e, d.onSelect = function() {
                        $("form.hide", c).submit()
                    }, "object" == typeof l.availableDays ? d.beforeShowDay = y : d.beforeShowDay = A, a.datepicker(d), a.data("feed-loaded", !0)
            }
            if ("AvailabilityCalendar" !== k.widgetType) {
                var o = $("#book-nights-holder", c).find("select");
                2 === k.dateSelection && $("option:eq(" + (index = k.defaultNumNight - k.minNumNight) + ")", o).prop("selected", !0), 3 === k.dateSelection && ($("option:eq(" + (index = k.defaultNumNight - k.minNumNight) + ")", o).prop("selected", !0), o.on("change", function() {
                    var c = a.datepicker("getDate");
                    c.setDate(c.getDate() + parseInt(this.value)), b.datepicker("setDate", c), i = parseInt(this.value)
                }), a.change(function() {}), b.change(function() {
                    i = lengthOfStay = M(a.datepicker("getDate"), b.datepicker("getDate")), index = lengthOfStay - k.minNumNight, $("option", o).prop("selected", !1), $("option:eq(" + index + ")", o).prop("selected", !0)
                })), $(".hasDatepicker", c).on("click", function() {
                    activeDatepicker = this.id
                }), $(".book-container").on("mouseover", function() {
                    $(this).find(".hasDatepicker").each(function() {
                        J($(this))
                    })
                }), $(".hasDatepicker", c).on("mouseover", function() {
                    J($(this))
                })
            }
        ...
        function J(a) {
            !0 !== a.data("feed-loaded") && (a.data("feed-loaded", !0), G(p, a))
        }

        function K() {
            activeDatepicker && $("#" + activeDatepicker).datepicker("refresh")
        }

        function L() {
            activeDatepicker && $("#ui-datepicker-div").is(":visible") && $("#" + activeDatepicker).datepicker("show")
        }

        function M(a, b) {
            var c = Math.abs(a.getTime() - b.getTime());
            return Math.ceil((c - 36e5) / 864e5)
        }

        function N(b, c) {
            var a = $('[data-translate="1"]', b);
            if (a.length > 0) {
                var d = BEDS24_LANGS;
                a.each(function(g, f) {
                    var a = $(f),
                        e = a.text(),
                        b = a.prop("tagName");
                    "LABEL" === b || "BUTTON" === b || "DIV" === b ? void 0 !== d[e] && void 0 !== d[e][c] && a.text(d[e][c]) : "SELECT" === b && $("option", a).each(function(f, e) {
                        var b = $(e),
                            a = b.text();
                        void 0 !== d[a] && void 0 !== d[a][c] && b.text(d[a][c])
                    })
                })
            }
        }
        ...
        function O(b) {
            var a = $('[data-allow-hide="1"]', b);
            a.length > 0 && a.each(function(b, a) {
                $(a).remove()
            })
        }
    }
